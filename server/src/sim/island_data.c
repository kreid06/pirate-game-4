...
IslandDef ISLAND_PRESETS[ISLAND_COUNT] = {
    ...
    /* ── Island 4: Crescent copy — rotated 90° (opens westward) ──────────
    ...
    /* ── Island 5: Crescent copy — rotated 180° (opens northward) ─────────
    ...
    /* ── Island 6: Crescent copy — rotated 270° (opens eastward) ──────────
    ...
    /* ── Island 7: Continental copy — rotated 45° ─────────────────────────
     * World centre (72000, 42000). */
    {
        ...
        .shallow_poly_scale = 1.375f,
        .vx = {
              2121,   2581,   3005,   3217,   2970,   2440,   1909,   1202,
               354,   -460,  -1167,  -1803,  -1556,  -1237,  -1167,  -1379,
             -1980,  -2828,  -3182,  -3253,  -3041,  -2440,  -1909,  -1167,
              -354,    424,   1096,   1732,
        },
        .vy = {
             -2121,  -1450,   -742,     35,    919,   1732,   2475,   2899,
              3253,   3217,   2934,   2510,   1909,   1379,   1167,   1237,
              1485,   1344,    566,   -212,   -990,  -1732,  -2475,  -2934,
             -3253,  -3182,  -2864,  -2440,
        },
        .resource_count = 8,
        .resources = {
    ...
    /* ── Island 8: Continental copy — rotated 90° ─────────────────────────
    ...
    /* ── Island 9: Continental copy — rotated 135° ────────────────────────
     * World centre (78000, 72000). */
    {
        .id               = 9,
        .x                = 78000.0f,
        .y                = 72000.0f,
