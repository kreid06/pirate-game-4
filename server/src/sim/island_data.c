...
IslandDef ISLAND_PRESETS[ISLAND_COUNT] = {
     ...
     * World centre (72000, 42000). */
    {
        ...
        .shallow_poly_scale = 1.375f,
        .vx = {
              2934,   2954,   2925,   2679,   1990,   1102,    253,   -571,
             -1475,  -2138,  -2577,  -2879,  -2344,  -1789,  -1614,  -1830,
             -2469,  -3104,  -2977,  -2612,  -2011,  -1102,   -253,    620,
              1475,   2089,   2479,   2782,
        },
        .vy = {
              -624,    190,   1014,   1782,   2388,   2782,   3115,   3086,
              2920,   2448,   1826,   1123,    754,    482,    343,    287,
               167,   -414,  -1259,  -1949,  -2486,  -2782,  -3115,  -3097,
             -2920,  -2438,  -1805,  -1102,
        },
        .resource_count = 8,
        .resources = {
            { .ox =    141.0f, .oy =  -1273.0f, .type_id = RES_FIBER },
            { .ox =   1414.0f, .oy =     0.0f,  .type_id = RES_FIBER },
            { .ox =    141.0f, .oy =   1556.0f, .type_id = RES_FIBER },
            { .ox =   -778.0f, .oy =  -1344.0f, .type_id = RES_FIBER },
     ...
     * World centre (48000, 76000). */
    {
        ...
        .shallow_poly_scale = 1.375f,
        .vx = {
              -877,  -1598,  -2305,  -2857,  -3054,  -2967,  -2848,  -2422,
             -1839,  -1105,   -348,    414,    477,    445,    482,    637,
              1051,   1867,   2544,   2972,   3149,   2967,   2848,   2408,
              1839,   1119,    377,   -384,
        },
        .vy = {
              2869,   2492,   2066,   1479,    583,   -384,  -1289,  -1995,
             -2706,  -3057,  -3139,  -3063,  -2416,  -1798,  -1578,  -1740,
             -2241,  -2514,  -1993,  -1340,   -553,    384,   1289,   2043,
              2706,   3009,   3043,   2967,
        },
        .resource_count = 8,
        .resources = {
            { .ox =   1000.0f, .oy =   -800.0f, .type_id = RES_FIBER },
            { .ox =   1000.0f, .oy =   1000.0f, .type_id = RES_FIBER },
            { .ox =  -1000.0f, .oy =   1200.0f, .type_id = RES_FIBER },
            { .ox =    400.0f, .oy =  -1500.0f, .type_id = RES_FIBER },
            { .ox =   1600.0f, .oy =  -2500.0f, .type_id = RES_ROCK  },
            { .ox =   1000.0f, .oy =   2500.0f, .type_id = RES_ROCK  },
            { .ox =  -1600.0f, .oy =   2400.0f, .type_id = RES_ROCK  },
            { .ox =  -1400.0f, .oy =  -2500.0f, .type_id = RES_ROCK  },
        },
    },
     ...
     * World centre (50000, 22000). */
    {
        ...
        .shallow_poly_scale = 1.375f,
        .vx = {
             -1763,  -1028,   -263,    538,   1373,   2093,   2743,   3051,
              3268,   3106,   2716,   2197,   1642,   1168,    970,   1007,
              1157,    884,     61,   -718,  -1453,  -2093,  -2743,  -3081,
             -3268,  -3076,  -2657,  -2138,
        },
        .vy = {
             -2427,  -2776,  -3084,  -3172,  -2789,  -2138,  -1499,   -734,
               160,    957,   1611,   2174,   1835,   1438,   1335,   1555,
              2188,   3004,   3231,   3179,   2848,   2138,   1499,    693,
              -160,   -917,  -1531,  -2093,
        },
        .resource_count = 8,
        .resources = {
            { .ox =   1273.0f, .oy =    141.0f, .type_id = RES_FIBER },
            { .ox =      0.0f, .oy =   1414.0f, .type_id = RES_FIBER },
            { .ox =  -1556.0f, .oy =    141.0f, .type_id = RES_FIBER },
            { .ox =   1344.0f, .oy =   -778.0f, .type_id = RES_FIBER },
            { .ox =   2899.0f, .oy =   -636.0f, .type_id = RES_ROCK  },
            { .ox =  -1061.0f, .oy =   2475.0f, .type_id = RES_ROCK  },
            { .ox =  -2828.0f, .oy =    566.0f, .type_id = RES_ROCK  },
            { .ox =    778.0f, .oy =  -2758.0f, .type_id = RES_ROCK  },
        },
    },
};
