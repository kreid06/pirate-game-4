...
void handle_craft_item(WebSocketPlayer* player, struct WebSocketClient* client, const char* payload) {
    ...
    static const CraftRecipe recipes[] = {
        ...
        { "craft_metal_axe",     ITEM_METAL_AXE,      1, { {ITEM_WOOD,   3}, {ITEM_METAL,  15},{0,0} }, 2, true  },
        { "craft_metal_pickaxe", ITEM_METAL_PICKAXE,  1, { {ITEM_WOOD,   3}, {ITEM_METAL,  12},{0,0} }, 2, true  },
        { "craft_metal_sickle",  ITEM_METAL_SICKLE,   1, { {ITEM_WOOD,   2}, {ITEM_METAL,  10},{ITEM_FIBER,5} }, 3, true  },
        { "craft_grapple_hook",  ITEM_GRAPPLE_HOOK,   1, { {ITEM_WOOD,   5}, {ITEM_METAL,   8},{ITEM_FIBER,5} }, 3, true  },
        { "craft_bucket",        ITEM_BUCKET,         1, { {ITEM_WOOD,   8}, {ITEM_FIBER,   4},{0,0} }, 2, true  },
